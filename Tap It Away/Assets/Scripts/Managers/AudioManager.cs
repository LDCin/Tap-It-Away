...
public class AudioManager : Singleton<AudioManager>
{
    ...
    {
        PlayOneShot(buttonClickSound != null ? buttonClickSound : defaultSfx);
    }

    public void PlayCubeMoveSound()
    {
        PlayOneShot(cubeMoveSound != null ? cubeMoveSound : defaultSfx);
    }

    public void PlayCubeBlockSound()
    {
        PlayOneShot(cubeBlockSound != null ? cubeBlockSound : defaultSfx);
    }

    public void PlayLevelSuccessSound()
    {
        PlayOneShot(levelSuccessSound != null ? levelSuccessSound : defaultSfx);
    }

    public void PlayLevelFailSound()
    {
        PlayOneShot(levelFailSound != null ? levelFailSound : defaultSfx);
    }

    public void PlayCoinFlySound()
    {
        PlayOneShot(coinFlySound != null ? coinFlySound : defaultSfx);
    }
